<template>
  <div class="mt-4 mb-40">
    ...
    <div class="mx-auto max-w-4xl text-center">
      <h1 class="mt-4 sm:mb-4 text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-3xl">Crear viaje</h1>
    </div>
    ...
    <div class="mx-auto mt-4 grid max-w-lg gap-8 sm:gap-10 lg:max-w-4xl lg:grid-cols-2">
      <div
        ...
        :class="[
          'bg-white/60 shadow-2xl p-8 rounded-3xl ring-1 ring-gray-900/10 sm:p-10 transition-transform duration-300 transform group',
