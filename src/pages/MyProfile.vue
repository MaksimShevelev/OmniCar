<template>
  <div class="space-y-12 mb-40">
    ...
    <div class="flex items-end gap-4 mt-4">
      ...
      <router-link to="/mi-perfil/editar" class="mb-6 text-black underline focus:bg-green-500 hover:bg-green-500 active:bg-green-900">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
          <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
          <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
        </svg>
      </router-link>
      <router-link to="/mi-perfil/editar/foto" class="mb-6 text-black underline focus:bg-green-500 hover:bg-green-500 active:bg-green-900">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <section>
        <h2 class="text-xl font-semibold text-gray-900">Información sobre ti</h2>
      ...
      <section>
        <h2 class="text-xl font-semibold text-gray-900">Información sobre tu auto</h2>
        <div class="mt-6 space-y-4">
          <div>
